...
sealed class DetailChatEvent with _$DetailChatEvent {
  ...
  const factory DetailChatEvent.streamMessages(String roomId) =
      DetailChatStreamMessages;
  const factory DetailChatEvent.sendMessage({
    required String roomId,
    required String text,
  }) = DetailChatSendMessage;

  const factory DetailChatEvent.onError(String message) = DetailChatOnError;
}
